...
<head>
    ...
    <title>Manage Students — EduQR</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .search-group { display: flex; align-items: center; gap: 8px; flex: 1; min-width: 200px; }
        .search-input {
        ...
        .btn-search:hover { background: #c73d0c; }
        .btn-print {
        ...
        .btn-print:hover { background: #1c2733; }
        ...
        @media print {
            .sidebar, .controls-bar, .btn-del, .btn-edit { display: none !important; }
            .main { margin-left: 0; }
        }
    </style>
</head>
    ...
    <main class="main">
        <div class="page-header">
            <div>
                ...
                <p>Search, edit, delete, and view all student records</p>
            </div>
        </div>

        <!-- CONTROLS -->
        <div class="controls-bar no-print">
            <form method="get" class="search-group" style="margin:0;">
        ...
        <%
            ...
            try {
                ...
                if (deleteId != null && !deleteId.trim().isEmpty()) {
                    ...
                    del.close();
                    alertMsg  = (rows > 0) ? "Student " + deleteId + " was deleted successfully." : "Delete failed.";
                    alertType = (rows > 0) ? "success" : "error";
                }
        ...
        <div class="alert alert-<%= alertType %>">
            <%= "success".equals(alertType) ? "✅" : "❌" %> <%= alertMsg %>
        </div>
        <% } %>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="ShowQRImageServlet?regno=<%= rs.getString("regno") %>"
                                 class="qr-thumb" width="60"
                                 onclick="openQR(this.src)" title="Click to enlarge">
                        </td>
                        <td class="no-print" style="white-space:nowrap;">
                            <a href="editStudent.jsp?regno=<%= rs.getString("regno") %>" class="btn-edit">✏ Edit</a>
                            &nbsp;
                            <form method="post" style="display:inline;"
                                  onsubmit="return confirm('Are you sure you want to delete student <%= rs.getString("regno") %>? This cannot be undone.');">
        ...
        %>
        <div class="alert alert-error">❌ Database Error: <%= e.getMessage() %></div>
        <% } %>
    </main>
